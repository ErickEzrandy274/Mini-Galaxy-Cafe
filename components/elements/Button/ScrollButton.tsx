...
const ScrollButton = () => {
	...
	const customClass = productLink.includes(pathname) ? `flex flex-col justify-center items-center gap-1 p-2` : `p-3`
	...
	return (
		...
		>
			...
			<p className={`text-[.6rem] ${productLink.includes(pathname) ? `block` : `hidden`}`}>
				Check
				<br /> Out
			</p>
		</button>
